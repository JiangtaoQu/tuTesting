# Generated by Django 2.2.2 on 2019-06-25 08:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campuses', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Campuses', verbose_name='校区')),
            ],
            options={
                'verbose_name': '课程表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_memo', models.TextField(blank=True, null=True, verbose_name='本节课程内容')),
                ...
                ('re_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.ClassList', verbose_name='班级')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('qq', models.CharField(help_text='QQ号码必须唯一', max_length=64, unique=True, verbose_name='QQ')),
                ('name', models.CharField(blank=True, help_text='真实姓名', max_length=32, null=True, verbose_name='姓名')),
                ('gender', models.IntegerField(blank=True, choices=[(1, '男'), (2, '女')], default=1, help_text='可以隐私保密', null=True, verbose_name='性别')),
                ('birthday', models.DateField(blank=True, default=None, help_text='格式YYYY-mm-dd', null=True, verbose_name='生日')),
                ('phone_number', models.CharField(blank=True, max_length=11, null=True, verbose_name='手机号')),
                ('source', models.CharField(choices=[('qq', 'qq群'), ('referral', '内部转介绍'), ('website', '官方网站'), ('baidu_ads', '百度推广'), ('office_direct', '直接上门'), ('WoM', '口碑'), ('public_class', '公开课'), ('other', '其他')], default='qq', max_length=64, verbose_name='客户来源')),
                ('course', multiselectfield.db.fields.MultiSelectField(choices=[('Linux', 'Linux中高级'), ('PythonFullStack', 'Python高级全栈开发')], max_length=21, verbose_name='课程咨询')),
                ...
                ('status', models.CharField(choices=[('signed', '已报名'), ('unregistered', '未报名'), ('studying', '学习中'), ('paid_in_full', '学费已交付')], default='unregistered', help_text='选择客户此时的状态', max_length=64, verbose_name='状态')),
                ...
                ('consultant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='consultant', to=settings.AUTH_USER_MODEL, verbose_name='销售')),
                ('introduce_from', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Customer', verbose_name='转介绍自学员')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrolment_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.ClassList', verbose_name='所报班级')),
            ],
            options={
                'verbose_name': '缴费记录表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('A', '近期无报名计划'), ('B', '1个月内报名'), ('C', '2周内报名'), ('D', '1周内报名'), ('E', '定金'), ('F', '到班'), ('G', '全款'), ('H', '无效')], help_text='客户当前状态', max_length=8, verbose_name='跟进状态')),
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Customer', verbose_name='所咨询客户')),
            ],
            options={
                'verbose_name': '跟进记录表',
        ...
        migrations.AddField(
            ...
            name='contract',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.ContractTemplate', verbose_name='选择合同模板'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='teachers',
        ...
        migrations.AddField(
            ...
            name='department',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Department'),
        ),
        migrations.AddField(
            model_name='userprofile',
            name='groups',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.CourseRecord', verbose_name='某节课程')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('why_us', models.TextField(blank=True, default=None, null=True, verbose_name='为什么报名')),
                ('your_expectation', models.TextField(blank=True, null=True, verbose_name='学完想达到的具体期望')),
                ...
                ('delete_status', models.BooleanField(default=False, verbose_name='删除状态')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Customer', verbose_name='客户名称')),
                ('enrolment_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.ClassList', verbose_name='所报班级')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Campuses', verbose_name='学校')),
            ],
            options={
                'verbose_name': '报名表',
